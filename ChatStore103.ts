      ...
      sendMessage: async (content) => {
        ...
        try {
          ...
          if (isAgentMode) {
            ...
            // Stream at consistent speed regardless of tab visibility
            let currentContent = '';
            let charIndex = 0;
            ...
            const streamNextChar = () => {
              if (charIndex < chars.length) {
                ...
                // Stream at blazing fast speed regardless of tab visibility
                streamingTimeout = setTimeout(streamNextChar, 0);
              } else {
