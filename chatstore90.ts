      ...
      sendMessage: async (content) => {
        ...
        try {
          ...
          if (isAgentMode) {
            ...
            // Simulate streaming by revealing text word by word (more natural and faster)
            let currentContent = '';
            let wordIndex = 0;
            const words = fullMessage.split(/\s+/); // Split on whitespace
            ...
            }, 8); // Super fast: 8ms per word - makes model feel lightning fast
          }
