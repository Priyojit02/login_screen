...
export function ChatArea() {
  ...
  // One unified "running" flag for header badge across both modes
  const showRunning = (isAgentActive || (isLoading && !isStreaming)) && !isStreaming;
    ...
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto scroll-smooth scrollbar-visible">
        <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
          ...
          {/* Typing indicator with status; only one instance */}
          {(!isStreaming && (
            (isAgentMode && currentJob && (currentJob.status === 'running' || currentJob.status === 'queued'))
