...
export function TypingIndicator({ status }: TypingIndicatorProps) {
  ...
  return (
    <div className="flex gap-4">
      {/* Avatar */}
      <div className="shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-gradient-to-br from-purple-500 to-pink-500 text-white">
      ...
      <div className="flex-1">
        ...
        <div className="inline-flex items-center gap-2 bg-message-user-light dark:bg-message-user-dark rounded-2xl rounded-tl-sm px-4 py-3">
          <motion.span
